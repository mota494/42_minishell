...
#FILES
SRCS = $(SRCD)000_utils.c $(SRCD)000_utils2.c $(SRCD)000_utils3.c $(SRCD)000_utils4.c $(SRCD)000_utils5.c $(SRCD)000_utils6.c $(SRCD)100_free2.c $(SRCD)100_free.c $(SRCD)100_main.c $(SRCD)100_main_loop.c $(SRCD)105_env.c $(SRCD)105_env_utils.c $(SRCD)200_check_syntax.c $(SRCD)200_syntax_utils.c $(SRCD)205_operators_check2.c $(SRCD)205_operators_check.c $(SRCD)210_syntax_error.c $(SRCD)300_get_line.c $(SRCD)300_get_line_utils.c $(SRCD)305_define_type.c $(SRCD)305_define_type_utils.c $(SRCD)400_parser.c $(SRCD)405_parse_line.c $(SRCD)405_parser_get_replace_var.c $(SRCD)405_parser_vars_dollar.c $(SRCD)410_parser_special.c $(SRCD)410_parser_tilde.c $(SRCD)415_heredoc.c $(SRCD)415_heredoc_signals.c $(SRCD)415_heredoc_utils.c $(SRCD)415_heredoc_utils2.c $(SRCD)500_execution.c $(SRCD)500_execution_run.c $(SRCD)505_exec_utils.c $(SRCD)505_exec_utils2.c $(SRCD)510_redirect_and_wait.c $(SRCD)510_redirect_one.c $(SRCD)510_redirects.c $(SRCD)510_redirects_utils.c $(SRCD)600_cd.c $(SRCD)600_echo.c $(SRCD)600_env_builtin.c $(SRCD)600_exit.c $(SRCD)600_pwd.c $(SRCD)600_unset.c $(SRCD)610_export.c $(SRCD)610_export_print.c $(SRCD)610_export_vars.c $(SRCD)700_signals.c 
