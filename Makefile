...
#FILES
SRCS = $(SRCD)000_utils.c $(SRCD)000_utils2.c $(SRCD)000_utils3.c $(SRCD)000_utils4.c $(SRCD)000_utils5.c $(SRCD)000_utils6.c $(SRCD)005_free.c $(SRCD)100_main.c $(SRCD)101_parse_quotes.c $(SRCD)101_parser.c $(SRCD)101_parser_get_replace_var.c $(SRCD)101_parser_special.c $(SRCD)101_parser_tilde.c $(SRCD)101_parser_vars.c $(SRCD)101_parser_vars_dollar.c $(SRCD)101_parser_vars_utils.c $(SRCD)103_env.c $(SRCD)103_env_utils.c $(SRCD)200_get_line.c $(SRCD)200_get_line_utils.c $(SRCD)203_define_type.c $(SRCD)204_define_type_utils.c $(SRCD)300_check_syntax.c $(SRCD)301_operators_check2.c $(SRCD)301_operators_check.c $(SRCD)302_syntax_error.c $(SRCD)303_syntax_utils.c $(SRCD)401_exit.c $(SRCD)402_echo.c $(SRCD)403_pwd.c $(SRCD)404_cd.c $(SRCD)405_env.c $(SRCD)406_export.c $(SRCD)406_export_print.c $(SRCD)406_export_vars.c $(SRCD)500_execution.c $(SRCD)501_exec_run.c $(SRCD)501_exec_utils.c $(SRCD)501_redirect_and_wait.c $(SRCD)502_redirects.c $(SRCD)600_heredoc.c $(SRCD)105_parse_line.c $(SRCD)407_unset.c $(SRCD)700_signals.c
