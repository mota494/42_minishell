...
#FILES
SRCS = $(SRCD)000_utils.c $(SRCD)100_main.c $(SRCD)101_parser.c $(SRCD)001_utils2.c $(SRCD)200_get_line.c $(SRCD)201_get_line_utils.c $(SRCD)203_define_type.c $(SRCD)002_utils3.c $(SRCD)300_check_syntax.c $(SRCD)301_operators_check.c $(SRCD)302_syntax_error.c $(SRCD)303_syntax_utils.c
